module github.com/scenarigo/scenarigo/examples/plugin-nil-bug/plugin/src

go 1.24.0

toolchain go1.25.0

require github.com/scenarigo/scenarigo v0.24.1
...
replace github.com/scenarigo/scenarigo v0.24.1 => ../../../..
